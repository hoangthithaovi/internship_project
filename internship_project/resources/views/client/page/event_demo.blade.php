				...
				<div class="events-bottom">
					@foreach($get_event as $data)
						<div class="col-md-6 events_bottom_left">
							...
							<a href="{{route('detailevents',$data->id)}}" title="{{$data->title_event}}"><img src="{{$data->folder.$data->attached_file}}" alt=" " style="width: 100%;height: 250px;" class="img-responsive"/></a>
